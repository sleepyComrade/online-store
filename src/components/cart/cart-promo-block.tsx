...
export default function CartPromoBlock({ cartItemsCount, totalCost, promoItem, setPromoItem, appliedPromoItems, setAppliedPromoItems, totalCostWithDiscount }: CartPromoBlockProps) {
